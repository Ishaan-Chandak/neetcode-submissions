// was able to understand the problem
// also created a solution - did not code it up
// missed the part where we need to check if the remainign elements in the array could make a string greater string
// understood that after seeing the solution
